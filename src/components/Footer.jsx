    ...
    >
      <div className="max-w-7xl mx-auto px-4 md:px-0 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="text-gray-100/90">📞 +92 322 3004719</p>
          <p className="text-gray-100/90">✉ nimrakhanofficial.12@gmail.com</p>
          <p className="text-gray-100/90">📍 Karachi, Pakistan</p>
          {/* Social Icons */}
          <div className="flex gap-4 mt-4">
            <a href="https://github.com/Nimrakhanofficial" target="_blank" className="hover:text-[#b86506] transition-colors duration-300">🔗 GitHub</a>
            <a href="https://www.linkedin.com/in/nimra-khan-0a2954309/" target="_blank" className="hover:text-[#b86506] transition-colors duration-300">🔗 LinkedIn</a>
          </div>
        </div>
      </div>
